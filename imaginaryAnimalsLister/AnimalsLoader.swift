...
struct AnimalsLoader
{
    func loadAnimals() -> [ImaginaryAnimal]
    {
        ...
        let lochness = ImaginaryAnimal(name: "Loch Ness Monster", height: 1.5,  location: "Scotland", dateLastSeen: "1951",
            imageURL: NSURL(string: "https://s3.amazonaws.com/glowscript/textures/flower_texture.jpg"));
        
        let bigfoot = ImaginaryAnimal(name: "Bigfoot", height: 1.5,  location: "North America", dateLastSeen: "1963",
